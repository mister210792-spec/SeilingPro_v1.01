...
const APP_VERSION_CODE = 150; // увеличивай на 1 при каждом обновлении
...
const VERSION_HISTORY = [
    ...
    },
    {
        ...
        date: '10.03.2026',
        changes: [
            '💡 Профессиональная расстановка света',
            '📏 Умные направляющие',
            '⚡ Ускорена загрузка проектов'
        ]
    },
    {
        version: '1.3.0',
